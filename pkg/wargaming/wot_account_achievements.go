...
type WotAccountAchievements struct {
	// Achievements earned
...
//     "vi" &mdash; Tiếng Việt 
//     "ko" &mdash; 한국어
func (client *Client) WotAccountAchievements(realm Realm, accountId []int, fields []string, language string) (*WotAccountAchievements, error) {
	...
	var result *WotAccountAchievements
