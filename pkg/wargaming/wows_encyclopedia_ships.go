...
type WowsEncyclopediaShips struct {
	// Ship description
...
func (client *Client) WowsEncyclopediaShips(realm Realm, fields []string, language string, limit int, nation []string, pageNo int, shipId []int, type_ []string) (*WowsEncyclopediaShips, error) {
	...
	var result *WowsEncyclopediaShips
