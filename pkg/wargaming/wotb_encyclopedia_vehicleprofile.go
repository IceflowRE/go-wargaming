...
type WotbEncyclopediaVehicleprofile struct {
...
func (client *Client) WotbEncyclopediaVehicleprofile(realm Realm, engineId int, tankId int, fields []string, gunId int, language string, profileId string, suspensionId int, turretId int) (*WotbEncyclopediaVehicleprofile, error) {
	...
	var result *WotbEncyclopediaVehicleprofile
