...
type WowsSeasonsShipstats struct {
	// User ID
...
func (client *Client) WowsSeasonsShipstats(realm Realm, accountId int, accessToken string, fields []string, language string, seasonId []int, shipId []int) (*WowsSeasonsShipstats, error) {
	...
	var result *WowsSeasonsShipstats
