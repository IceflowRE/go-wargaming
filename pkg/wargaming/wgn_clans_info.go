...
// WgnClansInfo Deprecated: Attention! The method is deprecated.
// Method returns detailed clan information. Information is available for World of Tanks and World of Warplanes clans.This method will be removed. Use method Clan details (World of Tanks)
//
...
func (client *Client) WgnClansInfo(realm Realm, clanId []int, accessToken string, extra []string, fields []string, game string, language string, membersKey string) (*WgnClansInfo, error) {
