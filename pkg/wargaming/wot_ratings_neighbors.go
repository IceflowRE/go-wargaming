...
type WotRatingsNeighbors struct {
	// Player account ID
...
// WotRatingsNeighbors Deprecated: Attention! The method is deprecated.
...
//     "vi" &mdash; Tiếng Việt 
//     "ko" &mdash; 한국어
func (client *Client) WotRatingsNeighbors(realm Realm, accountId int, limit int, rankField string, date UnixTime, type_ string, battleType string, fields []string, language string) (*WotRatingsNeighbors, error) {
	...
	var result *WotRatingsNeighbors
