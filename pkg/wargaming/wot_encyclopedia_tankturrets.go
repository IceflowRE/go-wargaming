...
// WotEncyclopediaTankturrets Method returns list of turrets.
//
...
func (client *Client) WotEncyclopediaTankturrets(realm Realm, fields []string, language string, moduleId []int, nation []string) (*wot.EncyclopediaTankturrets, error) {
	...
	var result *wot.EncyclopediaTankturrets
