...
//     "es" &mdash; Español 
//     "tr" &mdash; Türkçe
func (client *Client) WotxClansGlossary(realm Realm, fields []string, language string) (*WotxClansGlossary, error) {
