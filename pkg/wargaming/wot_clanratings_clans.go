...
type WotClanratingsClans struct {
	// Clan ID
...
//     "vi" &mdash; Tiếng Việt 
//     "ko" &mdash; 한국어
func (client *Client) WotClanratingsClans(realm Realm, clanId []int, date UnixTime, fields []string, language string) (*WotClanratingsClans, error) {
	...
	var result *WotClanratingsClans
