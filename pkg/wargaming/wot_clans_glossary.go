...
//     "vi" &mdash; Tiếng Việt 
//     "ko" &mdash; 한국어
func (client *Client) WotClansGlossary(realm Realm, fields []string, language string) (*WotClansGlossary, error) {
