...
type WowsEncyclopediaShipprofile struct {
...
func (client *Client) WowsEncyclopediaShipprofile(realm Realm, artilleryId int, diveBomberId int, engineId int, fighterId int, shipId int, fields []string, fireControlId int, flightControlId int, hullId int, language string, torpedoBomberId int, torpedoesId int) (*WowsEncyclopediaShipprofile, error) {
	...
	var result *WowsEncyclopediaShipprofile
