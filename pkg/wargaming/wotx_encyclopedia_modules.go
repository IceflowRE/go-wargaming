...
type WotxEncyclopediaModules struct {
	// Image link
...
func (client *Client) WotxEncyclopediaModules(realm Realm, extra []string, fields []string, language string, limit int, moduleId []int, nation []string, pageNo int, type_ []string) (*WotxEncyclopediaModules, error) {
	...
	var result *WotxEncyclopediaModules
