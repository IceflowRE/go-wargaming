...
//     "vi" &mdash; Tiếng Việt 
//     "ko" &mdash; 한국어
func (client *Client) WotEncyclopediaAchievements(realm Realm, fields []string, language string) (*wot.EncyclopediaAchievements, error) {
	...
	var result *wot.EncyclopediaAchievements
